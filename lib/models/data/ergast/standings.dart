...
class StandingsList {
    ...
    factory StandingsList.fromJson(Map<String, dynamic> json) => StandingsList(
        ...
        driverStandings: json["DriverStandings"] != null ? 
          List<DriverStanding>.from(json["DriverStandings"].map((x) => DriverStanding.fromJson(x))) : null,
        constructorStandings: json["ConstructorStandings"] != null ? 
          List<ConstructorStanding>.from(json["ConstructorStandings"].map((x) => ConstructorStanding.fromJson(x))) : null,
    );
...
class DriverStanding extends MediaItem {
    ...
    factory DriverStanding.fromJson(Map<String, dynamic> json) => DriverStanding(
        ...
        constructors: List<Constructor>.from(json["Constructors"].map((x) => Constructor.fromJson(x))),
    );
}
