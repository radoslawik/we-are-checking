import 'dart:convert';
import 'package:archive/archive.dart'; // Use archive to make it work on web
...
class LivetimingConversion {
  ...
  static String decodeToString(String rawInput) {
    ...
    final outputBytes = Inflate.buffer(InputStream(decodedString, byteOrder: BIG_ENDIAN)).getBytes();
